"""add cr_presentation_meetings table
...
def upgrade():
    op.create_table('cr_presentation_meetings',
    ...
    op.create_index(op.f('ix_cr_presentation_meetings_id'), 'cr_presentation_meetings', ['id'], unique=False)
    op.create_index(op.f('ix_cr_presentation_meetings_customer_requirement_id'), 'cr_presentation_meetings', ['customer_requirement_id'], unique=False)


def downgrade():
    op.drop_index(op.f('ix_cr_presentation_meetings_customer_requirement_id'), table_name='cr_presentation_meetings')
    op.drop_index(op.f('ix_cr_presentation_meetings_id'), table_name='cr_presentation_meetings')
    op.drop_table('cr_presentation_meetings')
